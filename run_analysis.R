...
# if you want to try this script yourself - comment the next string or set your own WD
setwd("/Users/nick/Desktop/CourseraR/DS_#3/CourseProject")

#download data
library(httr)
file.url <- "https://d396qusza40orc.cloudfront.net/getData%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
file.dest <- "rawdata.zip"
